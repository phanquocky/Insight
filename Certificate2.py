...
def creat_certificate_2(user_id = None, user_name = None):
  ...
  certificate = Certificate2_room(user_id=user_id, user_name=user_name)
  certificate_collection = db['Certificate2']
  certificate_collection.insert_one(certificate.__dict__)

def add_certificate_2_by_userid(user_id, certificate):
  certificate_collection = db['Certificate2']
  certificate = query_certificate_2_by_userid(user_id)
